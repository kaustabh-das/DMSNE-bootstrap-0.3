const machinary = document.getElementById("machinary");
     ...
     let t_str = "";
            snap.forEach((element, index) => {   //forEach is a loop where element carry the value and index carry the array index. 
               ...
               // let img = obj2.img;
                 ...
                 <div class="col" >
                    <div class="card text-center mt-4" style="width: 18rem;">
                        ...
                        <div class="card-body">
                          ...
                          <h5 class="card-title"><span>Rs. </span>${p_price} </h5>
                ...
                //     <div class="gallery">
                //         <a href=${p_img} target="_blank"><img src=${p_img} width="300" height="200"></a>
                //         <div class="content_info">
                //             <div class="name"><h4>${p_name}</h4></div>
                //             <div class="des"><p>Rs.<span> </span>${p_price}</p></div>
                //             <!-- <a href="#" class="button">Rs:<span> </span></span>${p_price}</a> -->
                //             <button type="button" id="${product_no}" class="button">View</button>
                //         </div>
                //     </div>
                // </div>`
            ...
            machinary.innerHTML = str;


            let info = document.getElementById("machinary");
